...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='MGJun-R4A'' package/lean/default-settings/files/zzz-default-settings
...
sed -i "s/OpenWrt /芒果俊/g" package/lean/default-settings/files/zzz-default-settings
